/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings ../../packages/server/worker-configuration.d.ts` (hash: a4180024d1b2b9612268cc840ebabb91)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../apps/web/src/worker");
	}
